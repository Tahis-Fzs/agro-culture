...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
									...
									<p><b>Category : </b></p>
<div class="3u 12u$(small)">
    <input type="radio" id="register_farmer" name="category" value="1" checked>
    <label for="register_farmer">Farmer</label>
</div>
<div class="3u 12u$(small)">
    <input type="radio" id="register_buyer" name="category" value="0">
    <label for="register_buyer">Buyer</label>
</div>
